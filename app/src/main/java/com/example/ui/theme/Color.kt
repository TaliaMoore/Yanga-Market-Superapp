...
val CharcoalBlack = Color(0xFF3B0764)      // Rich deep organic plum/purple (Tailwind purple-950) to completely avoid pure black while preserving high-contrast readability
...
val CosmicCardPurple = Color(0xFF3B0764)   // Deep warm organic violet card containers
val BrightNeonPurple = Color(0xFFD8B4FE)   // Glowing light wild orchid lavender purple
val PaleNeonYellow = Color(0xFFFEF08A)     // Soft autumn harvest yellow
val CosmicTextWhite = Color(0xFFFFFEF7)    // Pristine high-contrast beautiful Warm Ivory text
val TranslucentWhite = Color(0x1F3B0764)   // Semi-translucent depth overlay
